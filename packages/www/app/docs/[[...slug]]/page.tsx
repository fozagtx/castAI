...
export default async function Page({ params }: DocsPageProps) {
  ...
  const MDX = data.body;
  const markdownUrl = `/docs-md/${page.path.replace(/\.mdx$/, ".md")}`;
  const githubUrl = `https://github.com/fozagtx/castAI/blob/main/packages/www/content/docs/${page.path}`;

  return (
    <DocsPage full={data.full} toc={data.toc}>
      <div className="docs-page-actions">
        <MarkdownCopyButton
          aria-label="Copy this page as Markdown for ChatGPT"
          markdownUrl={markdownUrl}
        >
          <ChatGptMark aria-hidden="true" />
          Copy Markdown
        </MarkdownCopyButton>
