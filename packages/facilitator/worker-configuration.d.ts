...
declare namespace Cloudflare {
	...
	interface Env {
		CASPER_MAINNET_RPC_URL: string;
		CASPER_TESTNET_RPC_URL: string;
		CASPER_FACILITATOR_SIGNERS: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CASPER_MAINNET_RPC_URL" | "CASPER_TESTNET_RPC_URL" | "CASPER_FACILITATOR_SIGNERS">> {}
}
