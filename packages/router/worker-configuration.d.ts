...
declare namespace Cloudflare {
	...
	interface Env {
		...
		CASPER_MAINNET_PAY_TO: string;
		CASPER_TESTNET_PAY_TO: string;
		CASPER_MAINNET_PRIVATE_KEY: string;
		CASPER_TESTNET_PRIVATE_KEY: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FACILITATOR_URL" | "CASPER_MAINNET_PAY_TO" | "CASPER_TESTNET_PAY_TO" | "CASPER_MAINNET_PRIVATE_KEY" | "CASPER_TESTNET_PRIVATE_KEY">> {}
}
